...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        ### YOUR CODE HERE
        ### END YOUR CODE
        self.input_placeholder = tf.placeholder(shape=[self.batch_size,self.n_features],dtype=tf.float32, name="input_placeholder");
        self.labels_placeholder = tf.placeholder(shape=[self.batch_size, self.n_classes], dtype=tf.float32, name="labels_placeholder");
